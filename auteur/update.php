...
if ($valid) {
     ...
     $sql = "UPDATE auteur  set nom_aut= ?, email=?, url_photo=?,description=?  WHERE id_auteur = ?";
     $q = $pdo->prepare($sql);
     $q->execute(array($nom,$email,$phot,$desc,$id));
     Database::disconnect();
     header("Location:home.php");}
...
<div class="jumbotron ">
<div class="row" >
      <h4 color="blue"><u>modifier l'info du l'auteur:</u></h4>
</div>
